...
technologies used in \textbf{Guardrails Kit}.
...
Bash scripting, Git, YAML/Markdown, GitHub Actions basics.
...
\midrule
\endhead
  DevOps on AWS Specialization & \href{https://www.coursera.org/specializations/aws-devops}{\texttt{link}} & CI/CD pipelines, infrastructure-as-code, deployment automation. \\
\bottomrule
\caption{Coursera}
\end{longtable}
...
\midrule
\endhead
  GitHub Actions: The Big Picture & \href{https://www.pluralsight.com/courses/github-actions-big-picture}{\texttt{link}} & Workflow syntax, secrets, job dependencies — used in guardrails CI. \\
  Shell Scripting with Bash & \href{https://www.pluralsight.com/courses/bash-shell-scripting}{\texttt{link}} & Advanced Bash: heredocs, associative arrays, subshells. \\
\bottomrule
\caption{Pluralsight}
\end{longtable}
...
\midrule
\endhead
  DevOps Essentials & \href{https://acloudguru.com/course/devops-essentials}{\texttt{link}} & CI/CD, IaC, GitOps — all relevant to guardrails propagation. \\
\bottomrule
...
\begin{itemize}[leftmargin=1.5em]
  \item \href{https://github.com/github/super-linter}{\textbf{github/super-linter}} — Multi-language linting in GitHub Actions — extend guardrails CI.
  \item \href{https://github.com/pre-commit/pre-commit}{\textbf{pre-commit/pre-commit}} — Pre-commit hook framework; integrate validate_guardrails.sh as a hook.
\end{itemize}

\section{Reference Books}
\begin{itemize}[leftmargin=1.5em]
  \item \href{https://itrevolution.com/product/the-phoenix-project/}{\textit{The Phoenix Project}} — Kim, Behr, Spafford. DevOps culture and principles behind guardrails thinking.
\end{itemize}
