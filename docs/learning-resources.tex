...
Bash scripting, Git, YAML/Markdown, CI/CD pipelines, DevOps culture.
...
\midrule
\endhead
  DevOps on AWS Specialization & \href{https://www.coursera.org/specializations/aws-devops}{\texttt{link}} & Infrastructure-as-code and deployment automation. \\
\bottomrule
\caption{Coursera}
\end{longtable}
...
\midrule
\endhead
  GitHub Actions: The Big Picture & \href{https://www.pluralsight.com/courses/github-actions-big-picture}{\texttt{link}} & CI workflows and secrets. \\
\bottomrule
\caption{Pluralsight}
\end{longtable}
...
\begin{itemize}[leftmargin=1.5em]
  \item \href{https://github.com/pre-commit/pre-commit}{\textbf{pre-commit/pre-commit}} — Pre-commit hook framework.
\end{itemize}
